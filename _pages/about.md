...
1. **Chen Chen**, Qianfei Liu, Renpeng Xu, Ying Zhang, Huiru Wang<sup>#</sup>, and Qingmin Yu, **Multi-view support vector machine classifier via *L*<sub>0/1</sub> soft-margin loss with structural information**, *Information Fusion*, 2025, 102733. https://doi.org/10.1016/j.inffus.2024.102733.

2. Qianfei Liu, **Chen Chen**, Ting Huang, Yan Meng, and Huiru Wang<sup>#</sup>, **Multi-view structural twin support vector machine with the consensus and complementarity principles and its safe screening rules**, *Expert Systems with Applications*, 2025, 125814. https://doi.org/10.1016/j.eswa.2024.125814.

3. Niannian Deng, Renpeng Xu, Ying Zhang, Haoting Wang, **Chen Chen**, and Huiru Wang<sup>#</sup>, **Forest biomass carbon stock estimates via a novel approach: K-nearest neighbor-based weighted least squares multiple birth support vector regression coupled with whale optimization algorithm**, *Computers and Electronics in Agriculture*, 2025, 110020. https://doi.org/10.1016/j.compag.2025.110020.
   
4. Jingwen Li, Jianan Sun<sup>#</sup>, Mingyu Shao, Yinghui Lai and **Chen Chen**, **A New Multidimensional Computerized Testing Approach: On-the-Fly Assembled Multistage Adaptive Testing Based on Multidimensional Item Response Theory**, *Mathematics* 2025, 13(4), 594.
...
1. `2024.05` 基于蚁群优化算法与大间隔分类器联合的盆栽茎叶分离软件V1.0
1. `2024.05` 基于淘金优化的多视角加权孪生支持向量机盆栽茎叶分离软件V1.0
1. `2024.05` 基于能量谷优化的加权最小二乘孪生支持向量机盆栽茎叶分离软件V1.0
1. `2024.05` 基于粒子群优化算法与合叶损失支持向量机联合的柳树树叶树干分离软件V1.0
1. `2024.05` 基于开普勒优化算法与弹球损失支持向量机联合的杏树树叶树干分离软件V1.0
1. `2024.05` 基于混沌优化的加权孪生支持向量机盆栽茎叶分离软件V1.0
1. `2025.02` 基于斑马优化算法与滑道损失支持向量机联合的白蜡树树叶树干分离软件V1.0
...
* `2024.06` `省部级` `创新创业` 第十五届中国大学生服务外包创新创业大赛北部区域赛创新实践类二等奖
...
* `2024.05` `省部级` `艺术设计` 第十五届蓝桥杯视觉艺术设计赛北京赛区正式赛道（非命题）工业产品设计三等奖
...
* `2024.06 - 2025.xx` 北京林业大学理学院数学本科生党支部纪检委员
