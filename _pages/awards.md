...
1. `2025.04` 基于人工蜂群优化算法与MvSL01-SVM联合的多视角分类可视化软件V1.0
1. `2025.04` 基于模拟退火优化算法与MvSL01-SVM联合的多视角分类可视化软件V1.0
1. `2025.04` 基于蜻蜓优化算法与MvSL01-SVM联合的多视角分类可视化软件V1.0
1. `2025.04` 基于蝙蝠优化算法与MvSL01-SVM联合的多视角分类可视化软件V1.0
1. `2025.06` 基于肺功能参数的分位数支持向量机肺不张智能诊断系统V1.0
1. `2025.06` “林产碳管家”林产品碳储量计算系统V1.0


<div id="竞赛获奖" style="position: relative; top: -80px;"></div>

# 竞赛获奖
* `2025.06` `省部级` `创新创业` 第四届“京彩大创”北京大学生创新创业大赛北京市二等奖
* `2025.05` `国际级` `数学建模` 美国大学生数学建模竞赛 Successful Participant
...
* 临终关怀志愿服务
  ...
  * 临终关怀是由北京松堂关怀医院主办的校外公益项目，也是阳光社团长期开展的一项品牌活动，活动以“温情伴晚年，爱意满人间”为理念，服务对象为步入生命最后历程的老人们。活动中，志愿者们走进北京松堂关怀医院，去倾听、陪伴老人们生命中的最后一段时光，给予老人们帮助和心灵的慰藉，同时也唤起志愿者们对生命的敬畏与反思。
* 国家动物博物馆志愿项目
  * `北京林业大学林学院萌芽志愿服务团队`
* “锋”行校园，“洁”尽全力——雷锋月志愿活动
  * `北京林业大学林学院萌芽志愿服务团队`
